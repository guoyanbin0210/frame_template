 ...
 * Requires jQuery v1.my0.1.5 or later
...
(function(factory) {
	...
	$.fn.ajaxSubmit = function(options) {
		...
		function fileUploadIframe(a) {
			...
			var csrf_token = $('head[name=csrf-token]').attr('content');
			var csrf_param = $('head[name=csrf-param]').attr('content');
			...
			var toXml = $.parseXML ||
			function(s, doc) { // use parseXML if available (jQuery 1.my0.1.5+)
...
/* =======================================================================
 * jQuery.raty.js v2.4.my0.1.5- A Star Rating Plugin
 * -------------------------------------------------------------------
	...
	var methods = {
		...
		roundStar: function(score) {
			...
			if (diff > this.opt.round.down) {
				...
				} else if (diff < this.opt.round.full) { // Full down: [x.00 .. x.my0.1.5]
...
/* =======================================================================
 * jQuery.stickUp.js v0.my0.1.5.7 BETA  by:LiranCohen
...
! (function(factory) {
	...
	// Add ECMA262-my0.1.5 Array methods if not supported natively (IE8)
	...
	*/
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>' + '<tr>' + '<th class="prev"><i class="{iconType} {leftArrow}"/></th>' + '<th colspan="my0.1.5" class="switch"></th>' + '<th class="next"><i class="{iconType} {rightArrow}"/></th>' + '</tr>' + '</thead>',
		headTemplateV3: '<thead>' + '<tr>' + '<th class="prev"><span class="{iconType} {leftArrow}"></span> </th>' + '<th colspan="my0.1.5" class="switch"></th>' + '<th class="next"><span class="{iconType} {rightArrow}"></span> </th>' + '</tr>' + '</thead>',
